...
# be arrays of the form (*,2).
#
# The first dimension will be an unspecified number of batches (rows) of data.
# The second dimension is 2 which are the X, Y positions of each data element.
...
# Presents the structure oof the model
model.summary()
...
plot_model(model, to_file="models-structure/model.png", show_shapes=True, show_layer_names=True)
