...
# run 'tensorboard --logdir tb_logs --host=0.0.0.0' to see the results
logPath = "./tb_logs/"
...
with tf.name_scope('Conv2'):
    ...
    # Do convolution of the output of the 1st convolution layer. Pool result.
...
with tf.name_scope('FC'):
    ...
    # Connect output of pooling layer 2 as input to the full connected layer
...
with tf.name_scope('Dropout'):
    # Dropout some neurons to reduce over fitting
...
print('Test accuracy {0:.3f}%'.format(
    accuracy.eval(feed_dict={x: mnist.test.images, y_: mnist.test.labels, keep_prob: 1.0}) * 100.0))
