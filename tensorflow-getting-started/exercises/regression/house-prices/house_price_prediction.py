...
This code is part of Pluralsight's course "Tensorflow: Getting Started"
"""
...
# Set up Tensorflow placeholder that get updated as we descend down the gradient
...
with tf.Session() as sess:
    ...
    def initAnim():  # Init only required for blitting to give a clean slate
